...
[![License](https://img.shields.io/badge/License-BSD%203--Clause-blue.svg)](https://github.com/yvoinov/zrescue/blob/master/LICENSE)
...
Note:  Do not rename archives, archive names will use in zfsrestore for filesystem recovery with omitted target filesystem name.
